...
## 3. [Блокнтов с моделингом: отбор классификатора](https://github.com/GreyGreyWolf/Hackathons/blob/master/Yandex_music_2013/yandex_music_modelling_clf_by_team_13.ipynb)
...
## 4. [Блокнто с моделлингом: поиск похожих композиций и ранжирование](https://github.com/GreyGreyWolf/Hackathons/blob/master/Yandex_music_2013/yandex_music_modelling_faiss_by_team_13.ipynb)
...
# Итоги работы:
 ...
 - Реализован алгоритм поиска группы похожих композиций для указанного трека с ранжированием внутри года по типу трека и году выпуска.
